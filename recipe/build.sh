...
then
	...
	export JCC_LFLAGS="-v;-L$PREFIX/lib;-ljava;-L$PREFIX/lib/server;-ljvm;-Wl,-rpath;-Wl,$PREFIX/lib;-Wl,-rpath;-Wl,$PREFIX/lib/server;-mmacosx-version-min=$MACOSX_DEPLOYMENT_TARGET"
    ...
    # GNU/Linux recipe
    export JCC_ARGSEP=";"
	export JCC_LFLAGS="-v;-Wl,-v;-L$PREFIX/lib;-ljava;-L$PREFIX/lib/server;-ljvm;-lverify;-Wl,-rpath=$PREFIX/lib:$PREFIX/lib/server"
